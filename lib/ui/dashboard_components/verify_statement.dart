...
class VerifyStatement extends StatefulWidget {
  final webUrl;

  const VerifyStatement({Key? key, this.webUrl}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return VerifyStatementState();
  }
}
class VerifyStatementState extends State<VerifyStatement> with ScreenLoader{
  ...
  getUrl()async{
    startLoading();
    await  bankDetailsBloc.getVerifyStatementUrl(Map());
    stopLoading();
  }
  @override
  void dispose() {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        body: StreamBuilder<String>(
            stream: bankDetailsBloc.verifyStatementStream,
            builder: (context, snapshot) {
              ...
              return WebView(
                ...
                onPageFinished: (String url) async {
                  ...
                  // });
                  if(url.contains("https://www.gmoney.loans") || url.contains("https://www.gmoney.in") || url.contains('/SuccessPage')) {
