...
class SupplierPaymentsDetails extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return SupplierPaymentsDetailsState();
  }
}

class SupplierPaymentsDetailsState extends State<SupplierPaymentsDetails> {
      ...
      body: SingleChildScrollView(
        child: CommonCustomBG(
            ...
            widgetsOverGradient: AppBarBackArrow(
                title: "Supplier Payments Details", onTap: () => Navigator.pop(context)),
            isCardOnTop: false,
